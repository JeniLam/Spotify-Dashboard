...
def all_data():
    ...
    results = session.query(songs.title, songs.artist, songs.top_genre, songs.year, songs.energy, songs.dancability, songs.bpm, songs.dB, songs.duration_in_seconds, songs.acousticness, songs.popularity).all()
